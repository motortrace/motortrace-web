...
const SPSubscriptionPlanChart: React.FC<SubscriptionPlanChartProps> = ({
  data = [
    { label: 'Monthly Plan', value: 14, color: '#1a1a1a' },
    { label: '3 Month Plan', value: 19, color: '#333333' },
    { label: '6 Month Plan', value: 10, color: '#666666' },
    { label: 'Annual Plan', value: 7, color: '#999999' },
  ],
  title = 'Subscription Plan Distribution of Spare Parts Sellers',
  size = 425
}) => {
...
export default SPSubscriptionPlanChart;