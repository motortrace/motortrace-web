...
interface EditProductProps {
  category: string;
  existingData: EngineDrivetrainProduct;
  onSave: (data: EngineDrivetrainProduct) => void;
}

const EngineDrivetrainProductEditForm: React.FC<EditProductProps> = ({ existingData, onSave }) => {
  const [formData, setFormData] = useState<EngineDrivetrainProduct>(existingData);
  ...
  const handleChange = (field: keyof EngineDrivetrainProduct, value: any) => {
      ...
      <div className="edit-product__section">
        ...
        <div className="form-grid">
          ...
          <div className="form-group">
            ...
            <input type="text" value={formData.transmissionType || ''} onChange={(e) => handleChange('transmissionType', e.target.value)} />
          </div>
...
export default EngineDrivetrainProductEditForm;
